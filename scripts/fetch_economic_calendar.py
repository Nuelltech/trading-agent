...
def fetch_economic_calendar_fmp():
    ...
    if not records:
        ...
        records = [
            ...
            {"event_name": "FOMC Interest Rate Decision", "country": "EUA", "currency": "USD", "event_timestamp": f"{today.strftime('%Y-%m-%d')} 19:00:00", "impact_level": "HIGH", "actual_val": 5.25, "forecast_val": 5.25, "previous_val": 5.50, "unit": "%", "source_provider": "SYSTEM_FEED"},
